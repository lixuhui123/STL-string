...
//		cout << t1.find(0,7,'h') << endl;
//		cout<<t1.find(" ", 0, 7)<<endl;
//		/* rfind逆序查找 */
//
//		cout << t1.rfind(' ', t1.size())<<endl;
//		/* 截取一段字符串 */
//		cout << t1.substr(5, 45)<<endl;
//
//		/* string类的非成员函数 */
//		/* 输入输出重载函数，+，getline获取一行字符串 */
//		
//		//cin >> s1;
//		//cout << s1<<endl;/* getline在输入流里面直接读取 */
//		//getline(cin, s1);
//		//cout << s1 << endl;
//		//string p1;
//		//getline(cin,p1);/* 获取一行字符串,上面有cin单独输入的话，会跳过 */
//		//cout << p1 << endl;
//		cout << (s1> s2);
//		s1.c_str();
//
